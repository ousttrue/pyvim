...
def create_key_bindings():
    ...
    def vi_buffer_focussed():
        app = get_app()
        if app.layout.has_focus(editor.editor_layout.editor_root.window_arrangement.searchline.search_buffer) or app.layout.has_focus(editor.editor_layout.editor_root.commandline.command_buffer):
            return False
        return True
